  ...
  return <main className="min-h-dvh bg-[#07100e] pb-24">
    <header className="glass sticky top-0 z-20 border-b border-[#24352e]">
      <div className="mx-auto flex h-[64px] max-w-[880px] items-center justify-between gap-3 px-5">
        ...
        <Select value={lang} onValueChange={v=>setLang(v as "id"|"en")}><SelectTrigger aria-label={lang==="id"?"Bahasa panduan":"Guide language"} className="h-9 w-10 justify-center gap-0 rounded-lg border-[#2a3d35] bg-[#10201b] px-0 text-[#dce9e2] [&>[data-slot=select-value]]:hidden [&>svg:last-child]:hidden sm:w-[156px] sm:justify-between sm:gap-2 sm:px-2.5 sm:[&>[data-slot=select-value]]:flex sm:[&>svg:last-child]:block"><Languages size={14} className="shrink-0 text-[#71877d]"/><SelectValue className="text-[11px] leading-none"/></SelectTrigger><SelectContent align="end" className="border-[#2a3d35] bg-[#0d1916] text-xs text-[#dce9e2]"><SelectItem className="text-xs" value="id">Bahasa Indonesia</SelectItem><SelectItem className="text-xs" value="en">English</SelectItem></SelectContent></Select>
      </div>
    </header>
